...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-cli/random-port.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-cli/random-port.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-cli/</a> &#187; random-port.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function getRandomPort() {</span>
<span class="cstat-no" title="statement not covered" >    return new Promise((resolve, reject) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        const server = http_1.createServer();</span>
<span class="cstat-no" title="statement not covered" >        server.listen(0);</span>
<span class="cstat-no" title="statement not covered" >        server.once('listening', () =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            const port = server.address().port;</span>
<span class="cstat-no" title="statement not covered" >            server.close(() =&gt; <span class="cstat-no" title="statement not covered" >resolve(port))</span>;</span>
        });
<span class="cstat-no" title="statement not covered" >        server.once('error', reject);</span>
    });
}
