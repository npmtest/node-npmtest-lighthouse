...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-cli/commands/list-audits.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-cli/commands/list-audits.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-cli/commands/</a> &#187; list-audits.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function ListAudits() {</span>
<span class="cstat-no" title="statement not covered" >    const audits = lighthouse.getAuditList().map((i) =&gt; <span class="cstat-no" title="statement not covered" >i.replace(/\.js$/, ''))</span>;</span>
<span class="cstat-no" title="statement not covered" >    process.stdout.write(JSON.stringify({ audits }, null, 2));</span>
