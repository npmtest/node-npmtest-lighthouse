...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-core/closure/closure-type-checking.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-core/closure/closure-type-checking.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-core/closure/</a> &#187; closure-type-checking.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >const gutil = require('gulp-util');</span>
<span class="cstat-no" title="statement not covered" >const replace = require('gulp-replace');</span>
&nbsp;
/* eslint-disable camelcase */
<span class="cstat-no" title="statement not covered" >gulp.task('js-compile', <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  return gulp.src([</span>
    'closure/typedefs/*.js',
...
&nbsp;
    ...
    .on('error', error =&gt; {
<span class="cstat-no" title="statement not covered" >      gutil.log('Closure compilation failed. Check `closure-error.log` for details.');</span>
<span class="cstat-no" title="statement not covered" >      require('fs').writeFileSync('closure-error.log', error);</span>
    })
    .on('end', () =&gt; {
<span class="cstat-no" title="statement not covered" >      gutil.log('Closure compilation successful.');</span>
    });
});
/* eslint-enable */
&nbsp;
<span class="cstat-no" title="statement not covered" >gulp.start('js-compile');</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
