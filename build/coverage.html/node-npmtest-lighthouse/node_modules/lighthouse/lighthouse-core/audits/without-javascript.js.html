...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-core/audits/without-javascript.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-core/audits/without-javascript.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-core/audits/</a> &#187; without-javascript.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    const artifact = artifacts.HTMLWithoutJavaScript;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (artifact.value.trim() === '') {</span>
<span class="cstat-no" title="statement not covered" >      return WithoutJavaScript.generateAuditResult({</span>
        rawValue: false,
