...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-core/gather/gatherers/gatherer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-core/gather/gatherers/gatherer.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-core/gather/gatherers/</a> &#187; gatherer.js</div>
</div>
<div class="body">
...
class Gatherer {
   ...
   * @return {string}
   */
  get name<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return this.constructor.name;</span>
  }
&nbsp;
...
&nbsp;
   ...
   */
  beforePass<span class="fstat-no" title="function not covered" >(options) {</span> }
&nbsp;
  /**
   ...
   * @param {!Object} options
   */
  pass<span class="fstat-no" title="function not covered" >(options) {</span> }
&nbsp;
  /**
   ...
   * @return {*|!Promise&lt;*&gt;}
   */
  afterPass<span class="fstat-no" title="function not covered" >(options, loadData) {</span> }
&nbsp;
