...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-core/third_party/traceviewer-js/extras/chrome/chrome_user_friendly_category_driver.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-core/third_party/traceviewer-js/extras/chrome/chrome_user_friendly_category_driver.js</span></h1>
    <h2>
        
        Statements: <span class="metric">68.29% <small>(28 / 41)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
