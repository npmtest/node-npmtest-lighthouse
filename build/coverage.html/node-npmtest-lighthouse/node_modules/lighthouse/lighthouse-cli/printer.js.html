...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-cli/printer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-cli/printer.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">32.58% <small>(29 / 89)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric">6 statements, 1 function, 1 branch</span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-cli/</a> &#187; printer.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function checkOutputPath(path) {</span>
<span class="cstat-no" title="statement not covered" >    if (!path) {</span>
<span class="cstat-no" title="statement not covered" >        log.warn('Printer', 'No output path set; using stdout');</span>
...
<span class="fstat-no" title="function not covered" >function formatAggregationResultItem(score, suffix = '') {</span>
<span class="cstat-no" title="statement not covered" >    if (typeof score === 'boolean') {</span>
<span class="cstat-no" title="statement not covered" >        return score ? `${log.greenify(log.tick)}` : `${log.redify(log.cross)}`;</span>
    }
<span class="cstat-no" title="statement not covered" >    if (typeof score !== 'number') {</span>
<span class="cstat-no" title="statement not covered" >        return `${log.purple}${score}${log.reset}`;</span>
    }
<span class="cstat-no" title="statement not covered" >    let colorChoice = log.red;</span>
<span class="cstat-no" title="statement not covered" >    if (score &gt; 45) {</span>
<span class="cstat-no" title="statement not covered" >        colorChoice = log.yellow;</span>
    }
<span class="cstat-no" title="statement not covered" >    if (score &gt; 75) {</span>
<span class="cstat-no" title="statement not covered" >        colorChoice = log.green;</span>
    }
<span class="cstat-no" title="statement not covered" >    return `${colorChoice}${score}${suffix}${log.reset}`;</span>
}
/**
 * Creates the results output in a format based on the `mode`.
 */
<span class="fstat-no" title="function not covered" >function createOutput(results, outputMode) {</span>
<span class="cstat-no" title="statement not covered" >    const reportGenerator = new ReportGenerator();</span>
    // HTML report.
<span class="cstat-no" title="statement not covered" >    if (outputMode === OutputMode.html) {</span>
<span class="cstat-no" title="statement not covered" >        return reportGenerator.generateHTML(results, 'cli');</span>
    }
    // JSON report.
<span class="cstat-no" title="statement not covered" >    if (outputMode === OutputMode.json) {</span>
<span class="cstat-no" title="statement not covered" >        return JSON.stringify(results, null, 2);</span>
    }
    // No report (the new default)
<span class="cstat-no" title="statement not covered" >    if (outputMode === OutputMode.none)</span>
<span class="cstat-no" title="statement not covered" >        return '';</span>
    // Pretty printed CLI report.
<span class="cstat-no" title="statement not covered" >    const version = results.lighthouseVersion;</span>
<span class="cstat-no" title="statement not covered" >    let output = `\n\n${log.bold}Lighthouse (${version}) results:${log.reset} ${results.url}\n\n`;</span>
<span class="cstat-no" title="statement not covered" >    results.aggregations.forEach(aggregation =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        const total = aggregation.total ? ': ' + formatAggregationResultItem(Math.round(aggregation.total * 100), '%') : '';</span>
<span class="cstat-no" title="statement not covered" >        output += `${log.whiteSmallSquare} ${log.bold}${aggregation.name}${log.reset}${total}\n\n`;</span>
<span class="cstat-no" title="statement not covered" >        aggregation.score.forEach(item =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            const score = (item.overall * 100).toFixed(0);</span>
<span class="cstat-no" title="statement not covered" >            if (item.name) {</span>
<span class="cstat-no" title="statement not covered" >                output += `${log.bold}${item.name}${log.reset}: ${item.scored ? formatAggregationResultItem(score, '%') : ''}\n`;</span>
            }
<span class="cstat-no" title="statement not covered" >            item.subItems.forEach(subitem =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                let auditResult;</span>
<span class="cstat-no" title="statement not covered" >                if (typeof subitem === 'string') {</span>
<span class="cstat-no" title="statement not covered" >                    auditResult = results.audits[subitem];</span>
                }
                else {
<span class="cstat-no" title="statement not covered" >                    auditResult = subitem;</span>
                }
<span class="cstat-no" title="statement not covered" >                const formattedScore = auditResult.error ? `${log.redify('‽')}` :</span>
                    `${formatAggregationResultItem(auditResult.score)}`;
<span class="cstat-no" title="statement not covered" >                let lineItem = ` ${log.doubleLightHorizontal} ${formattedScore} ${auditResult.description}`;</span>
<span class="cstat-no" title="statement not covered" >                if (auditResult.displayValue) {</span>
<span class="cstat-no" title="statement not covered" >                    lineItem += ` (${log.bold}${auditResult.displayValue}${log.reset})`;</span>
                }
<span class="cstat-no" title="statement not covered" >                output += `${lineItem}\n`;</span>
<span class="cstat-no" title="statement not covered" >                if (auditResult.debugString) {</span>
<span class="cstat-no" title="statement not covered" >                    output += `    ${auditResult.debugString}\n`;</span>
                }
<span class="cstat-no" title="statement not covered" >                if (auditResult.extendedInfo &amp;&amp; auditResult.extendedInfo.value) {</span>
<span class="cstat-no" title="statement not covered" >                    const formatter = Formatter.getByName(auditResult.extendedInfo.formatter).getFormatter('pretty');</span>
<span class="cstat-no" title="statement not covered" >                    output += `${formatter(auditResult.extendedInfo.value)}`;</span>
                }
            });
 ...
 */
<span class="fstat-skip" title="function not covered" >function writeToStdout(output) {</span>
<span class="cstat-skip" title="statement not covered" >    return new Promise((resolve, reject) =&gt; {</span>
        // small delay to avoid race with debug() logs
<span class="cstat-skip" title="statement not covered" >        setTimeout(_ =&gt; {</span>
<span class="cstat-skip" title="statement not covered" >            process.stdout.write(`${output}\n`);</span>
<span class="cstat-skip" title="statement not covered" >            resolve();</span>
        }, 50);
    });
}
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function writeFile(filePath, output, outputMode) {</span>
...
<span class="cstat-no" title="statement not covered" >        fs.writeFile(filePath, output, 'utf8', (err) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            if (err) {</span>
<span class="cstat-no" title="statement not covered" >                return reject(err);</span>
            }
<span class="cstat-no" title="statement not covered" >            log.log('Printer', `${OutputMode[outputMode]} output written to ${filePath}`);</span>
 ...
 * Writes the results.
 */
<span class="fstat-no" title="function not covered" >function write(results, mode, path) {</span>
<span class="cstat-no" title="statement not covered" >    return new Promise((resolve, reject) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        const outputPath = checkOutputPath(path);</span>
<span class="cstat-no" title="statement not covered" >        const output = createOutput(results, OutputMode[mode]);</span>
        ...
        /* istanbul ignore if */
<span class="cstat-no" title="statement not covered" >        if (outputPath === 'stdout') {</span>
<span class="cstat-skip" title="statement not covered" >            return writeToStdout(output).then(_ =&gt; <span class="cstat-skip" title="statement not covered" >resolve(results))</span>;</span>
        }
<span class="cstat-no" title="statement not covered" >        return writeFile(outputPath, output, OutputMode[mode]).then(_ =&gt; {</span>
