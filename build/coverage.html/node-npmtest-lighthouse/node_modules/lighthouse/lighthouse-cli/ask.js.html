...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-cli/ask.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-cli/ask.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lighthouse/node_modules/lighthouse/lighthouse-cli/</a> &#187; ask.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function ask(question, options) {</span>
<span class="cstat-no" title="statement not covered" >    return new Promise((resolve, reject) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        const iface = readline.createInterface(process.stdin, process.stdout);</span>
<span class="cstat-no" title="statement not covered" >        const optionsStr = options.map((o, i) =&gt; <span class="cstat-no" title="statement not covered" >i + 1 + '. ' + o)</span>.join('\r\n');</span>
<span class="cstat-no" title="statement not covered" >        iface.setPrompt(question + '\r\n' + optionsStr + '\r\nChoice: ');</span>
<span class="cstat-no" title="statement not covered" >        iface.prompt();</span>
<span class="cstat-no" title="statement not covered" >        iface.on('line', (_answer) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            const answer = toInt(_answer);</span>
<span class="cstat-no" title="statement not covered" >            if (answer &gt; 0 &amp;&amp; answer &lt;= options.length) {</span>
<span class="cstat-no" title="statement not covered" >                iface.close();</span>
<span class="cstat-no" title="statement not covered" >                resolve(options[answer - 1]);</span>
            }
            else {
<span class="cstat-no" title="statement not covered" >                iface.prompt();</span>
            }
...
exports.ask = ask;
<span class="fstat-no" title="function not covered" >function toInt(n) {</span>
<span class="cstat-no" title="statement not covered" >    const result = parseInt(n, 10);</span>
<span class="cstat-no" title="statement not covered" >    return isNaN(result) ? 0 : result;</span>
}
